  ...
  <div class="form-container p-4 border rounded shadow-sm bg-white">
    ...
    <form action="resetPwd" method="post">
      <div class="mb-3">
        ...
        <input type="email" id="email" name="email" placeholder="Enter your email" value ="${email}" class="form-control" required>
      </div>

      <div class="mb-3">
        <label for="token" class="form-label">Token</label>
        <input type="password" id="token" name="token" placeholder="Enter Your Token" class="form-control" required>
      </div>
